...
export default function SubscriptionPage() {
  return (
    <div className="page-shell">
      ...
      <section className="content-section light-band">
        <div className="mx-auto grid w-full max-w-7xl gap-8 px-5 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
          <Reveal className="glass-panel">
            ...
            <div className="mt-8 grid gap-3">
              {planBenefits.map((benefit) => (
                <article key={benefit.title} className="rounded-2xl border border-black/10 bg-black/[0.03] px-5 py-4">
          ...
          <Reveal delay={0.06}>
            <div className="glass-panel divide-y divide-black/10 overflow-hidden p-0">
              {faqs.map((faq) => (
                <article key={faq.question} className="px-8 py-8">
